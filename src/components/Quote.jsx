...
const Quote = () => {
  ...
  return (
    <>
      <div className="quote min-h-[100vh] w-[100%] flex flex-col gap-4 p-4 ">
        {quotes && quotes.length>0 ? quotes.map((ele)=>
           <div key={ele.id} className="card text-white bg-gray-800 py-6 px-10 rounded-lg m-4">
          <h1 className="md:text-xl sm:text-lg text-sm font-bold mb-4">{ele.quotes}</h1>
